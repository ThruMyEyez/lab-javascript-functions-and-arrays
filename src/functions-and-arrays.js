...
// Bonus - Iteration #4.1
//console.time("Timer"); // Performance mes.
function avg(arr) {
  if (!arr.length) {
    return null;
  }
...
console.time("Timer Iteration: 5");
...
console.timeEnd("Timer Iteration: 5");
...
//console.log(doesWordExist(["machine"], "machine"));
...
console.timeEnd("Timer Iteration7:");
// Iteration #8: Bonus
const matrix = [
